...
class SkillCategoryResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Kategori keahlian';

    protected static ?string $modelLabel = 'Kategori keahlian';

    protected static ?string $pluralModelLabel = 'Kategori keahlian';
